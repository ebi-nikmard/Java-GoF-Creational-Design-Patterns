...
public class StreetMap {
    ...
    public static void main(String args[]) {
        StreetMap map = new StreetMap.Builder(new Point(50, 50), new Point(100, 100)).landColor(Color.GRAY).waterColor(Color.BLUE.brighter())
                .build();

        System.out.println(map.origin + " " + map.destination + " " + map.waterColor + " " + map.highTrafficColor + " " + map.landColor + " " + map.mediumTrafficColor + " " + map.lowTrafficColor);
